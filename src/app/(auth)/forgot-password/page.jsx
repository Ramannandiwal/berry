...
function Forgot() {
  ...
  const handleSubmit = async () => {
    ...
    toast.success("Still in progress", { duration: 1300 });
  };
      ...
      <div className="bg-[#eef2f6] h-screen w-screen flex justify-center items-center">
        ...
        <div className="bg-[#ffffff] w-[28rem] rounded-xl m-8 flex items-center justify-around flex-col">
          ...
          <div className="mt-5 text-center">
            <div className="text-[#009d89] font-bold text-2xl">Forgot Password ?</div>
            <div className="text-[#6b7287] font-bold">
          ...
          <div className="mt-3 bg-yellow-50 w-[85%] border-t-2 border-[#009d89]"></div>
