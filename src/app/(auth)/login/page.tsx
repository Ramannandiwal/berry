...
function Login() {
  ...
  const handleSubmit = async () => {
   ...
   try {
     ...
     toast.error(data,{duration:1300});
   }
  ...
  return (
    <div className=" bg-[#eef2f6] h-screen w-screen flex justify-center items-center ">
      ...
      <div className="  bg-[#ffffff] w-[28rem] rounded-xl m-8 flex items-center  justify-around flex-col">
        ...
        <div className=" flex w-full items-center justify-between">
          <div className="  flex items-center p-2">
            <input
              ...
              checked={checked}
              id="checked"
              className=" ml-5 form-radio text-[#009d89] border-[#009d89] h-5 w-5"
        ...
        <div className=" mt-3 bg-yellow-50 w-[90%] border-t-2 border-[#009d89]">
