    ...
    <div className=" bg-[#eef2f6] h-screen w-screen flex justify-center items-center ">
      <div className="  bg-[#ffffff] w-[28rem] flex items-center m-8 rounded-xl  justify-around flex-col">
        ...
        <div className=" flex w-full items-center justify-between">
          <div className="  flex items-center p-2">
            ...
            onChange={()=>{}}
              ...
              checked={checked}
              id="checked"
              className=" ml-3 form-radio text-[#009d89] border-[#009d89] h-6 w-6 b"
              style={{
                accentColor: checked ? "#009d89" : "#009d89",
                borderRadius: 0,
              }} // Set the color here
            />
        ...
        <div className=" w-full flex items-center justify-center">
          <button onClick={()=>{handlerSubmit()}} className=" text-white p-2 font-bold rounded-md w-[90%] h-[3rem] bg-[#009d89]">
            Sign up{" "}
          </button>
        </div>
